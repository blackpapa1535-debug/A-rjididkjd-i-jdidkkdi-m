# ================================================================
# AIMAI KEY SERVER — RENDER DEPLOYMENT READY
# ================================================================
# features:
#  - Admin panel (password: @no_one15_3&love)
#  - Custom keys (any characters allowed)
#  - Key verify API
#  - Heartbeat API (60-sec auto-kill)
#  - Server master ON/OFF toggle
#  - IP / Device tracking
#  - Copy key buttons
#  - Full logs
# ================================================================
...
app = Flask(__name__)
app.secret_key = "aimai_super_secret_key_2026_change_this_in_production"

# Render pe /data folder use karo persistent storage ke liye
...
# ================================================================
# API — HEARTBEAT (app har 60 sec bhejega)
# ================================================================
